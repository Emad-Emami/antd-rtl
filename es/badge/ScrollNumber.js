...
var ScrollNumber = function (_Component) {
    ...
    _createClass(ScrollNumber, [{
        ...
        value: function render() {
            ...
            var newProps = _extends({}, restProps, { className: classNames((_classNames = {}, _defineProperty(_classNames, '' + prefixCls, !!prefixCls), _defineProperty(_classNames, '' + className, !!className), _classNames)), title: count });
